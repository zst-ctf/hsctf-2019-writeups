public class VirtualJavaModified {
    ...
    private VirtualJavaModified(int[] instructions) {
    ...
    void print_psuedocode(int opc, int opn) {
            switch (opc) {
                case 0x0:
                    //push(pop() + pop());
                    System.out.println("add_stack " + opn);
                    break;
                case 0x1: {
                    //int y = pop();
                    //int x = pop();
                    //push(x - y);
                    System.out.println("sub_stack " + opn);
                    break;
                }
                case 0x2:
                    //push(pop() * pop());
                    System.out.println("mul_stack " + opn);
                    break;
                case 0x3:
                    //int y = pop();
                    ///int x = pop();
                    //push(x / y);
                    System.out.println("div_stack " + opn);
                    break;
                case 0x4:
                    //if (pop() == 0) this.ip = opn;
                    System.out.println("zero_jmp " + opn);
                    break;
                case 0x5:
                    //if (pop() != 0) this.ip = opn;
                    System.out.println("one_jmp " + opn);
                    break;
                case 0x6:
                    //push(opn);
                ...
                case 0x7:
                    //push(pop() & pop());
                    System.out.println("and_stack " + opn);
                    break;
                case 0x8:
                    //push(pop() | pop());
                    System.out.println("or_stack " + opn);
                    break;
                case 0x9:
                    //push(pop() ^ pop());
                    System.out.println("xor_stack " + opn);
                    break;
                case 0xa:
                    //int a = pop();
                    //push(a);
                    //push(a);
                    System.out.println("dup_stack " + opn);
                    break;
                case 0xb:
                    //push(this.regs[opn]);
                    System.out.println("push_params " + opn + " => " + this.regs[opn]);
                    break;
                case 0xc:
                    //this.running = false;
                    System.out.println("halt " + opn);
                    break;
            }
            print_stack();
    }
    ...
    public static void main(String... args) {
        ...
        VirtualJavaModified java = new VirtualJavaModified(new int[]{0xb, 0x0, 0x6, 0x0, 0x1, 0x64, 0x5, 0x14, 0xb, 0x1, 0x6,
